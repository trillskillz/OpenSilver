...
6. **KCC20 SDK follow-through** — helper surface now covers planning/state normalization plus transaction-shape planning. Next work: compile/deploy glue once the desired compiler integration path is chosen.
