...
- Hardened payout patterns (`Escrow bilateral`, `Atomic Swap HTLC`, `Freelance / Payroll`, `TimeLock`, `Vault release`, `Streaming Payment`, `Vesting`) with explicit output-0 destination and value-conservation checks where tractable.
