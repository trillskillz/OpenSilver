...
- Phase 3.1 through 3.7 are underway with compiler-validated `contracts/core/ownable.sil`, `contracts/core/multisig.sil`, `contracts/core/timelock.sil`, `contracts/core/vault.sil`, `contracts/core/escrow-bilateral.sil`, `contracts/core/escrow-milestone.sil`, and `contracts/core/streaming-payment.sil` scaffolds, plus matching docs/tests.
